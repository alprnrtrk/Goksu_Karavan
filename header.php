...
<body <?php body_class(); ?> class="max-w-[100vw] overflow-hidden">
  <?php wp_body_open(); ?>
  <header class="group/header fixed z-[999] top-0 left-0 w-screen h-[100px]">
    <a href="<?php echo esc_url(home_url('/')); ?>" class="min-md:group-[&.scrolled-down]/header:-translate-y-[150px] fixed z-[88] top-0 left-[30px] md:left-[20px] w-[100px] md:scale-[.8] md:origin-top-left min-md:hover:pt-[30px] flex border border-t-0 border-white/25 bg-primary/15 rounded-b-full overflow-hidden duration-500">
