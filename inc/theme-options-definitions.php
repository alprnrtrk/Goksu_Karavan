...
function auriel_theme_get_design_token_fields(): array
{
  $fields = [
    ...
    [
      'name' => 'social_twitter',
      'label' => __('Twitter', AURIEL_THEME_TEXT_DOMAIN),
      'type' => 'text',
      'default' => '',
      'instructions' => __('Full URL to your Twitter / X profile.', AURIEL_THEME_TEXT_DOMAIN),
    ],
    [
      'name' => 'social_instagram',
      'label' => __('Instagram', AURIEL_THEME_TEXT_DOMAIN),
      'type' => 'text',
      'default' => '',
      'instructions' => __('Full URL to your Instagram profile.', AURIEL_THEME_TEXT_DOMAIN),
    ],
    [
      'name' => 'social_facebook',
      'label' => __('Facebook', AURIEL_THEME_TEXT_DOMAIN),
      'type' => 'text',
      'default' => '',
      'instructions' => __('Full URL to your Facebook page.', AURIEL_THEME_TEXT_DOMAIN),
    ],
    [
      'name' => 'social_youtube',
      'label' => __('YouTube', AURIEL_THEME_TEXT_DOMAIN),
      'type' => 'text',
      'default' => '',
      'instructions' => __('Full URL to your YouTube channel.', AURIEL_THEME_TEXT_DOMAIN),
    ],
    [
      'name' => 'primary_color',
    ...
    [
      ...
      'label' => __('Footer description', AURIEL_THEME_TEXT_DOMAIN),
      'type' => 'text',
      'default' => '',
      'instructions' => __('Short descriptive blurb shown in the footer.', AURIEL_THEME_TEXT_DOMAIN),
    ],
    [
      'name' => 'footer_phone',
      'label' => __('Footer phone', AURIEL_THEME_TEXT_DOMAIN),
      'type' => 'text',
      'default' => '',
      'instructions' => __('Primary phone number displayed in the footer.', AURIEL_THEME_TEXT_DOMAIN),
    ],
    [
      'name' => 'footer_mail',
      'label' => __('Footer email', AURIEL_THEME_TEXT_DOMAIN),
      'type' => 'text',
      'default' => '',
      'instructions' => __('Primary contact email shown in the footer.', AURIEL_THEME_TEXT_DOMAIN),
    ],
    [
      'name' => 'footer_adress',
      'label' => __('Footer address', AURIEL_THEME_TEXT_DOMAIN),
      'type' => 'text',
      'default' => '',
      'instructions' => __('Postal address lines for the footer.', AURIEL_THEME_TEXT_DOMAIN),
    ],
  ];
