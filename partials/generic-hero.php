...
<section id="generic-hero" data-partial="generic-hero" class="relative w-screen h-[75vh]">
  <div data-swiper="wrapper" class="absolute top-0 left-0 swiper w-full h-full">
    <div class="absolute z-[10] inset-0">
      ...
      <div class="absolute inset-0 flex flex-col items-start justify-end w-full h-full p-[30px_150px] md:p-[30px] text-white">
    ...
    <div class="swiper-wrapper">
      <?php foreach ($images as $image): ?>
        <div class="swiper-slide relative text-white overflow-hidden">
          <img class="absolute inset-0 w-full h-full object-bottom object-cover" data-swiper-parallax="20%" data-swiper-parallax-scale="1.1" src="<?php echo esc_url(auriel_theme_resolve_image_attributes($image['image'])['src']) ?>" alt="">
        </div>
      <?php endforeach; ?>
    </div>
  </div>
