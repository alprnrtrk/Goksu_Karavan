...
<section id="user-comments" data-partial="user-comments" class="relative w-screen h-auto bg-surface py-[100px] md:py-[50px]">
        ...
        <div class="swiper-wrapper min-md:!ease-linear will-change-transform">
          <?php foreach ($comments as $comment): ?>
            <div class="swiper-slide !flex !items-center will-change-transform group/slide">
              <div class="relative w-full h-[300px] md:h-[350px] border border-text/25 rounded-[20px] overflow-hidden">
                ...
                <div class="w-full h-full flex flex-col gap-[10px] p-[20px_30px] bg-black/40">
                  <div class="flex flex-col items-center gap-[10px]">
                    ...
                    <h3 class="text-2xl text-white"><?php echo $comment['user-name'] ?></h3>
                  ...
                  <p class="text-center text-lg leading-[1.2rem] text-white">
