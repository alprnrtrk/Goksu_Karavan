...
<body <?php body_class(); ?>>
  ...
  <header class="fixed z-[999] top-0 left-0 w-full h-[100px]">
    <div class="md:absolute md:top-0 md:right-0 md:w-full md:h-screen md:flex md:flex-col md:p-[15px] md:bg-primary/50 md:backdrop-blur-2xl">
      <a href="<?php echo esc_url(home_url('/')); ?>" class="fixed top-0 left-[30px] w-[100px] md:scale-75 md:origin-top-left p-[10px] pb-[20px] border border-white/25 rounded-b-full overflow-hidden">
