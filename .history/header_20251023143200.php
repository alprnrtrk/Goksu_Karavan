...
<body <?php body_class(); ?>>
  ...
  <header class="fixed z-[999] top-0 left-0 w-full h-[100px]">
    ...
    <button class="active group/toggle min-md:hidden fixed top-[20px] right-[20px] size-[60px] flex flex-col gap-[5px] items-center justify-center rounded-full border border-white/25 overflow-hidden">
      ...
      <span class="-group-[&.active]/toggle:translate-y-[7px] group-[&.active]/toggle:translate-x-[4px] group-[&.active]/toggle:rotate-45 origin-top-left block w-[30px] h-[2px] bg-white"></span>
      <span class="group-[&.active]/toggle:opacity-0 block w-[30px] h-[2px] bg-white"></span>
      <span class="group-[&.active]/toggle:translate-y-[7px] group-[&.active]/toggle:translate-x-[4px] group-[&.active]/toggle:-rotate-45 origin-bottom-left block w-[30px] h-[2px] bg-white"></span>
    </button>
