...
<body <?php body_class(); ?>>
  ...
  <header class="fixed z-[999] top-0 left-0 w-full h-[100px]">
    ...
    <nav class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 p-[15px_25px] border border-white/25 rounded-full bg-white/10 overflow-hidden
      [&>.menu]:
      [&>.menu>ul]:flex
      [&>.menu>ul]:gap-[10px]
      [&>.menu>ul]:p-[5px_0px]
            ...
            <feImage preserveAspectRatio="none" result="radialMap" href="data:image/svg+xml;utf8,
              <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'>
                <radialGradient id='g' cx='50%' cy='50%' r='50%'>
                  ...
                  <stop offset='80%' stop-color='rgb(135,135,135)'/> <!-- almost neutral -->
                  <stop offset='90%' stop-color='rgb(200,200,200)'/> <!-- some push -->
