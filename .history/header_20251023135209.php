...
<body <?php body_class(); ?>>
  ...
  <header class="fixed z-[999] top-0 left-0 w-full h-[100px]">
    <a href="<?php echo esc_url(home_url('/')); ?>" class="fixed top-0 left-0">
      <img class="w-full h-full object-contain" src="<?php echo esc_url(auriel_theme_resolve_image_attributes(auriel_theme_get_design_token('brand_logo'))['src']) ?>" alt="<?php echo esc_url(auriel_theme_resolve_image_attributes(auriel_theme_get_design_token('brand_logo'))['alt']) ?>">
    </a>
