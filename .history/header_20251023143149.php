...
<body <?php body_class(); ?>>
  ...
  <header class="fixed z-[999] top-0 left-0 w-full h-[100px]">
    <a href="<?php echo esc_url(home_url('/')); ?>" class="fixed top-0 left-[30px] md:left-[20px] w-[100px] md:scale-[.8] md:origin-top-left p-[15px] pb-[30px] border border-white/25 rounded-b-full overflow-hidden">
    ...
    <button class="active group/toggle min-md:hidden fixed top-[20px] right-[20px] size-[60px] flex flex-col gap-[5px] items-center justify-center rounded-full border border-white/25 overflow-hidden">
      <div class="absolute z-[-1] top-0 left-0 w-full h-full glass-bg">
        <svg width="0" height="0" class="absolute z-[-1]">
          <filter id="realistic-glass-lens" x="0%" y="0%" width="100%" height="100%">
            <feImage preserveAspectRatio="none" result="radialMap" href="data:image/svg+xml;utf8,
      ...
      <span class="-group-[&.active]/toggle:translate-y-[7px] group-[&.active]/toggle:mb-[10px] group-[&.active]/toggle:translate-x-[4px] group-[&.active]/toggle:rotate-45 origin-top-left block w-[30px] h-[2px] bg-white"></span>
      <span class="group-[&.active]/toggle:opacity-0 block w-[30px] h-[2px] bg-white"></span>
      <span class="group-[&.active]/toggle:translate-y-[7px] group-[&.active]/toggle:mb-[10px] group-[&.active]/toggle:translate-x-[4px] group-[&.active]/toggle:-rotate-45 origin-bottom-left block w-[30px] h-[2px] bg-white"></span>
    </button>
    <div class="md:translate-x-full md:absolute md:top-0 md:right-0 md:w-full md:h-screen md:flex md:flex-col md:p-[15px] md:bg-primary/50 md:backdrop-blur-2xl">
