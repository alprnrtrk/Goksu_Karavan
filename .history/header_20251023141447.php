...
<body <?php body_class(); ?>>
  ...
  <header class="fixed z-[999] top-0 left-0 w-full h-[100px]">
    <div class="md:absolute md:top-0 md:right-0 md:w-full md:h-screen md:bg-primary/50 md:backdrop-blur-2xl">
      <a href="<?php echo esc_url(home_url('/')); ?>" class="fixed top-0 left-[30px] w-[100px] md:scale-75 md:origin-top-left p-[10px] pb-[30px] border border-white/25 rounded-b-full overflow-hidden">
      ...
      <nav class="min-md:absolute top-1/2 left-1/2 min-md:-translate-x-1/2 min-md:-translate-y-1/2 p-[15px_10px] md:pt-[120px] min-md:border border-white/25 min-md:rounded-full overflow-hidden
            [&>.menu]:
            [&>.menu>ul]:flex
            md:[&>.menu>ul]:flex-col
            [&>.menu>ul]:gap-[10px]
            ...
            min-md:[&>.menu>ul>li>a]:border
            min-md:[&>.menu>ul>li>a]:rounded-full
            [&>.menu>ul>li>a]:border-white/50
            [&>.menu>ul>li>a]:text-white
            md:[&>.menu>ul>li>a]:text-3xl
            [&>.menu>ul>li>a]:font-semibold
            [&>.menu>ul>li>a]:tracking-widest
            min-md:[&>.menu>ul>li>a]:backdrop-blur-3xl
            min-md:[&>.menu>ul>li>a]:backdrop-brightness-[.99]
      ...
      <ul class="fixed top-1/2 -translate-y-1/2 right-[30px] flex flex-col items-center justify-center gap-[10px] p-[10px] border border-white/25 rounded-full overflow-hidden">
        <div class="absolute z-[-1] top-0 left-0 w-full h-full glass-bg">
          <svg width="0" height="0" class="absolute z-[-1]">
            <filter id="realistic-glass-lens" x="0%" y="0%" width="100%" height="100%">
              <feImage preserveAspectRatio="none" result="radialMap" href="data:image/svg+xml;utf8,
        ...
        <li>
          <a href="#" class="flex items-center justify-center size-[40px] rounded-full border border-white/25 hover:bg-primary/50 text-white/75 hover:text-white backdrop-blur-3xl backdrop-brightness-[.99] duration-500">
