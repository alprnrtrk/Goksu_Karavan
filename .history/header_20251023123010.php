...
<body <?php body_class(); ?>>
  <img class="absolute z-[50] top-0 left-0 w-full h-screen" src="https://www.reddit.com/media?url=https%3A%2F%2Fpreview.redd.it%2F7jw4kd2797w61.png%3Fwidth%3D320%26crop%3Dsmart%26auto%3Dwebp%26s%3D3b3fb5675e5c27f9e1f3a8b0b45044600f772955" alt="">
  <?php wp_body_open(); ?>
    ...
    ">
      <div class="absolute z-[-1] top-0 left-0 w-full h-full glass-bg">
        <svg width="0" height="0" class="hidden">
          <filter id="subtle-edge-lens" x="0%" y="0%" width="100%" height="100%">

            <!-- Step 1: Create radial alpha map for edge distortion -->
            <feImage preserveAspectRatio="none" result="radialMap" href="data:image/svg+xml;utf8,
              <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'>
                <radialGradient id='g' cx='50%' cy='50%' r='50%'>
                  <stop offset='0%' stop-color='rgb(128,128,128)'/>
                  <stop offset='20%' stop-color='rgb(150,150,150)'/>
                  <stop offset='30%' stop-color='rgb(255,255,255)'/>
                </radialGradient>
                <rect x='0' y='0' width='100' height='100' fill='url(%23g)'/>
              </svg>" />

            <!-- Step 2: Apply radial displacement for subtle lens effect -->
            <feDisplacementMap in="SourceGraphic" in2="radialMap" scale="50" xChannelSelector="R" yChannelSelector="G" result="distorted" />

            <!-- Step 3: Mild blur to soften edges -->
            <feGaussianBlur in="distorted" stdDeviation="1.5" result="softened" />

            <!-- Output -->
            <feBlend in="softened" in2="SourceGraphic" mode="lighten" />
