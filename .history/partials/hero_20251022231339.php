...
<section data-gsap-parallax-image data-partial="hero" class="relative w-screen h-[500vh] bg-blue-500">
  <div data-gsap-parallax-image="wrapper" class="relative w-full h-screen overflow-hidden">
    ...
    <div data-gsap-parallax-image="image" data-gsap-parallax-image-power=".6" class="absolute z-[2]">
      <h2 class="">Test Yazi 1</h2>
    </div>
    ...
    <h2 data-gsap-parallax-image="image" data-gsap-parallax-image-power=".6 class=" absolute z-[4]">Test Yazi 1</h2>
