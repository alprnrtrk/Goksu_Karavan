...
<section data-gsap-parallax-image data-partial="hero" class="relative w-screen h-screen md:h-[75vh] bg-blue-500">
  <div data-gsap-parallax-image="wrapper" class="relative w-full h-full overflow-hidden">
    ...
    <div data-gsap-parallax-image="image" data-gsap-parallax-image-power="1.2" class="absolute z-[2] top-0 left-0 text-7xl md:text-3xl font-bold w-full h-[50vh] pt-[100px] flex justify-center md:items-end md:bg-blue-500 text-center text-white">
      <h2>Test Yazi 1</h2>
    </div>
    ...
    <div data-gsap-parallax-image="image" data-gsap-parallax-image-power=".6" class="absolute z-[4] bottom-0 left-0 text-7xl md:text-3xl font-bold w-full h-[50vh] min-md:pb-[100px] flex justify-center bg-red-500 text-center text-white">
      <h2>Test Yazi 1</h2>
    </div>
