...
<body <?php body_class(); ?>>
  ...
  <header class="fixed z-[999] top-0 left-0 w-full h-[100px]">
    <a href="<?php echo esc_url(home_url('/')); ?>" class="fixed z-[88] top-0 left-[30px] md:left-[20px] w-[100px] md:scale-[.8] md:origin-top-left p-[15px] pb-[30px] border border-white/25 bg-primary/25 backdrop-brightness-[.9] rounded-b-full overflow-hidden">
    ...
    <button data-mobile-toggler class="group/toggle min-md:hidden fixed z-[88] top-[20px] right-[20px] size-[60px] rounded-full border border-white/25 bg-primary/25 backdrop-brightness-[.9] overflow-hidden">
      <div class="absolute z-[-1] top-0 left-0 w-full h-full glass-bg">
        <svg width="0" height="0" class="absolute z-[-1]">
          <filter id="realistic-glass-lens" x="0%" y="0%" width="100%" height="100%">
            <feImage preserveAspectRatio="none" result="radialMap" href="data:image/svg+xml;utf8,
    ...
    <div data-mobile-menu class="md:[&.active]:translate-x-0 md:translate-x-full md:absolute md:top-0 md:right-0 md:w-full md:h-screen md:flex md:flex-col md:p-[15px] md:bg-primary/25 md:backdrop-blur-3xl duration-500 ease-smooth">
      <nav class="min-md:absolute top-1/2 left-1/2 min-md:-translate-x-1/2 min-md:-translate-y-1/2 p-[15px_10px] md:pt-[120px] min-md:border border-white/25 bg-primary/25 backdrop-brightness-[.9] min-md:rounded-full overflow-hidden [&>.menu]: [&>.menu>ul]:flex md:[&>.menu>ul]:flex-col [&>.menu>ul]:gap-[10px] [&>.menu>ul]:p-[5px_0px] [&>.menu>ul>li>a]:p-[10px_15px] md:[&>.menu>ul>li>a]:p-[10px_0px] min-md:[&>.menu>ul>li>a]:border min-md:[&>.menu>ul>li>a]:rounded-full [&>.menu>ul>li>a]:border-white/25 [&>.menu>ul>li>a]:text-white md:[&>.menu>ul>li>a]:text-3xl [&>.menu>ul>li>a]:font-semibold [&>.menu>ul>li>a]:tracking-widest min-md:[&>.menu>ul>li>a]:backdrop-blur-3xl min-md:[&>.menu>ul>li>a]:backdrop-brightness-[.99] [&>.menu>ul>li>a]:duration-500 [&>.menu>ul>li>a:hover]:bg-primary/50">
        <div class="absolute z-[-1] top-0 left-0 w-full h-full glass-bg">
          <svg width="0" height="0" class="absolute z-[-1]">
            <filter id="realistic-glass-lens" x="0%" y="0%" width="100%" height="100%">
              <feImage preserveAspectRatio="none" result="radialMap" href="data:image/svg+xml;utf8,
      ...
      <ul class="min-md:fixed top-1/2 min-md:-translate-y-1/2 right-[30px] flex min-md:flex-col items-center justify-center md:justify-start gap-[10px] p-[10px] md:mt-auto min-md:border border-white/25 bg-primary/25 backdrop-brightness-[.9] rounded-full overflow-hidden">
        <div class="absolute z-[-1] top-0 left-0 w-full h-full glass-bg">
          <svg width="0" height="0" class="absolute z-[-1]">
            <filter id="realistic-glass-lens" x="0%" y="0%" width="100%" height="100%">
              <feImage preserveAspectRatio="none" result="radialMap" href="data:image/svg+xml;utf8,
