  ...
  <header class="fixed z-[999] top-0 left-0 w-full h-[100px]">
    ...
    <button data-mobile-toggler class="group/toggle min-md:hidden fixed z-[88] top-[20px] right-[20px] size-[60px] rounded-full border border-white/25 overflow-hidden">
      ...
      <div class="flex flex-col gap-[5px] items-center justify-center group-[&.active]/toggle:translate-y-[-3px]">
        <span class="-group-[&.active]/toggle:translate-y-[7px] group-[&.active]/toggle:translate-x-[4px] group-[&.active]/toggle:rotate-45 origin-left block w-[30px] h-[2px] bg-white duration-500 ease-smooth"></span>
        <span class="group-[&.active]/toggle:opacity-0 block w-[30px] h-[2px] bg-white duration-500 ease-smooth"></span>
        <span class="group-[&.active]/toggle:translate-y-[7px] group-[&.active]/toggle:translate-x-[4px] group-[&.active]/toggle:-rotate-45 origin-left block w-[30px] h-[2px] bg-white duration-500 ease-smooth"></span>
      </div>
    </button>
    <div data-mobile-menu class="md:[&.active]:translate-x-0 md:translate-x-full md:absolute md:top-0 md:right-0 md:w-full md:h-screen md:flex md:flex-col md:p-[15px] md:bg-primary/50 md:backdrop-blur-2xl duration-500 ease-smooth">
