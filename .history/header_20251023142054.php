...
<body <?php body_class(); ?>>
  ...
  <header class="fixed z-[999] top-0 left-0 w-full h-[100px]">
    <a href="<?php echo esc_url(home_url('/')); ?>" class="fixed top-0 left-[30px] w-[100px] md:scale-[.8] md:origin-top-left p-[15px] pb-[30px] border border-white/25 rounded-b-full overflow-hidden">
    ...
    <button class="min-md:hidden fixed top-[50px] right-[15px] size-[15px] bg-red-500">
