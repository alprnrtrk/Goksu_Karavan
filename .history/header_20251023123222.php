...
<body <?php body_class(); ?>>
  <img class="absolute z-[50] top-0 left-0 w-full h-screen" src="https://a.fsdn.com/con/app/proj/testsuite240p/screenshots/grid.png/245/183/1" alt="">
  <?php wp_body_open(); ?>
            ...
            <feImage preserveAspectRatio="none" result="radialMap" href="data:image/svg+xml;utf8,
              <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'>
                <radialGradient id='g' cx='50%' cy='50%' r='50%'>
                  ...
                  <stop offset='90%' stop-color='rgb(150,150,150)'/>
