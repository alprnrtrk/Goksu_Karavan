...
<body <?php body_class(); ?>>
  ...
  <header class="fixed z-[999] top-0 left-0 w-full h-[100px]">
    ...
    <ul class="fixed top-1/2 -translate-y-1/2 right-[30px] flex flex-col items-center justify-center p-[10px] border border-white/25 rounded-full overflow-hidden">
      ...
      <li>
        <a href="#" class="flex items-center justify-center size-[40px] rounded-full border border-white/25 text-white/75 backdrop-blur-3xl backdrop-brightness-[.99] duration-500">
