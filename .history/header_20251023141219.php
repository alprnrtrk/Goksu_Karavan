...
<body <?php body_class(); ?>>
  ...
  <header class="fixed z-[999] top-0 left-0 w-full h-[100px]">
    <div class="md:absolute md:top-0 md:right-0 md:w-full md:h-screen md:bg-primary/25 md:backdrop-blur-xl">
      ...
      <nav class="min-md:absolute top-1/2 left-1/2 min-md:-translate-x-1/2 min-md:-translate-y-1/2 p-[15px_10px] md:pt-[100px] border border-white/25 min-md:rounded-full overflow-hidden
            [&>.menu]:
            [&>.menu>ul]:flex
            md:[&>.menu>ul]:flex-col
            [&>.menu>ul]:gap-[10px]
            ...
            [&>.menu>ul>li>a]:backdrop-blur-3xl
            [&>.menu>ul>li>a]:backdrop-brightness-[.99]
